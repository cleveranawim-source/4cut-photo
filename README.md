...
- 전면 카메라 미리보기와 5초 카운트다운
- 포즈를 바꿔가며 네 장 자동 촬영
- 사진 필터 8종(원본·뽀샤시·화사·선명·따뜻·시원·흑백·빈티지)
- 프레임 테마 6종(살구 크림·베리 팝·미드나잇·민트 소다·라벤더·오션 블루)
- 사진 아래에 넣을 문구 입력
- 촬영 과정 720p 타임랩스 영상 생성·저장
...
> 모든 처리는 iPad 브라우저 안에서만 이뤄집니다. 사진과 타임랩스 영상은 서버로 전송되지 않습니다.
